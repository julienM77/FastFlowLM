...
void Gemma3_Text_Only::load_model(std::string model_path, json model_info, int default_context_length) {
...
/************              Gemma3 family            **************/
Gemma3::Gemma3(unsigned int device_id) : AutoModel(device_id) {}

void Gemma3::load_model(std::string model_path, json model_info, int default_context_length) {
    this->_shared_load_model(model_path, model_info, default_context_length);
