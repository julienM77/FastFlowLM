...
#include "AutoModel/modeling_deepseek.hpp"

/************              DeepSeek_r1_8b family            **************/
DeepSeek_r1_8b::DeepSeek_r1_8b(unsigned int device_id) : AutoModel(device_id) {}

void DeepSeek_r1_8b::load_model(std::string model_path, json model_info, int default_context_length) {
...
void DeepSeek_r1_0528_8b::load_model(std::string model_path, json model_info, int default_context_length) {
    this->_shared_load_model(model_path, model_info, default_context_length);
