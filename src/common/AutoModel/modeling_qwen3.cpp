...
void Qwen3::load_model(std::string model_path, json model_info, int default_context_length) {
    this->_shared_load_model(model_path, model_info, default_context_length);
...
void Qwen3_IT::load_model(std::string model_path, json model_info, int default_context_length) {
    this->_shared_load_model(model_path, model_info, default_context_length);
...
void Qwen3_TK::load_model(std::string model_path, json model_info, int default_context_length) {
    this->_shared_load_model(model_path, model_info, default_context_length);
