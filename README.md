...
- NPU-accelerated kernels are **proprietary binaries**: free for **non-commercial use**, and for **commercial use only if your company’s annual revenue is USD 10 million or less**. Above that threshold, a commercial license is required. See [LICENSE_BINARY.txt](./LICENSE_BINARY.txt) and [TERMS.md](./TERMS.md) for details.  
