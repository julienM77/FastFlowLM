...
5. Enter the **Provider URL**: `http://localhost:11434/v1`.
...
5. Enter the **Provider URL**: `http://localhost:11434`.
...
📌 _Scenario_: You wrote some short notes in Obsidian, but they look too simple.  
...
📌 _Scenario_: You started a paragraph but don’t know how to continue.  
...
📌 _Scenario_: You have a long article or meeting notes that take too much time to read.  
...
📌 _Scenario_: You typed something fast and it’s full of mistakes.  
